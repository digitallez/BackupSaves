...
public partial class ProfileEditWindow : Window
{
    ...
    private void Save_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show(this, "Укажите BackupRoot.", "BackupSaves", MessageBoxButton.OK, MessageBoxImage.Warning);
            return;
        }
        ...
        {
            MessageBox.Show(this, "Retention должен быть ≥ 1.", "BackupSaves", MessageBoxButton.OK, MessageBoxImage.Warning);
            return;
        }
